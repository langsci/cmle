...
\caption{{The {\it Brightness Colour Strategy} also allows a population of agents (in this case 10)
...
\caption{ Example of a conceptualization for the phrase ``near to the box". {\it Top:} 
