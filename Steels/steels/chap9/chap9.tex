...
\caption{\small\label{fig:sideview} 
...
The N01SE exhibition was curated by Adam Lowe (see figure \ref{fig:lowe}) and Simon Schaffer. 
...
and animated television and radio programs, including {\it Light Fantastic} (BBC4). 
\begin{figure}[htbp]
  \centerline{\includegraphics[width=.70\textwidth]{chap9/figs/lowe}}
\caption{\small\label{fig:lowe} 
...
\begin{quotation}
{\it A multi-site multimedia exhibition in Cambridge with ``realtime" links to London, organised around three key themes in ``digitality":
\begin{verbatim}
   Universal Language 
   Pattern Recognition 
   Data Synaesthetics
...
\begin{quotation}
{\it Digitality is transforming traditional ways of thinking about the impact of technology on culture. This exhibition 
...
\caption{\small\label{fig:program} 
...
and the computers driving the software (see Figure \ref{fig:london-heads}). The London site posed particularly hard 
...
\caption{\small\label{fig:london-heads} 
...
\noindent
{\bf Situated robots and teleports}
...
\noindent
{\bf Constructing perceptually grounded concepts}
...
{\bf 2000-02-25 21:37:24 Yeah8a8y}\\
{\it Paris}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-25 21:40:13 Yeah8a8y}\\
{\it RE: Paris}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-25 21:55:49 Trash}\\
{\it YELLOW MK 1 ESCORT}\\
...
{\small
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-25 22:02:36 LondonCalling}\\
{\it CALIBRATION OF CAMERAS London}\\
"Can London PLEASE calibrate their cameras???? PLEASE!!!!!\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-26 16:52:32 Yeah8a8y}\\
{\it RE: CALIBRATION OF CAMERAS London}\\
very good.... Absolutely no chance of Domination if the cameras arn't calibrated... SORT IT!!\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-02 15:46:50} phlox\\
{\it RE: CALIBRATION OF CAMERAS}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-03 20:08:36 schedski}\\
{\it RE: CALIBRATION OF CAMERAS London}\\
wassup fish?\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-03 23:06:43 fish}\\
{\it RE: CALIBRATION OF CAMERAS London}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-07 13:03:46 A Londoner}\\
{\it RE: CALIBRATION OF CAMERAS London}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-26 16:47:55 Yeah8a8y}\\
{\it RE: teaching}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-26 20:41:20 Trash}\\
{\it RE: teaching / TRIBES}	\\
...
God us 2 are good!!\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-27 19:39:55 smartypants}\\
{\it RE: Collusion Tribes}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-27 20:46:29 smartypants}\\
{\it RE: Collusion Tribes}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-28 14:25:01 Yeah8a8y}\\
{\it RE: Collusion Tribes}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-28 16:24:47 Yeah8a8y}\\
{\it RE: Collusion  Tribes}\\
OK no... I'm no girl!!! But there you go... I'm a bloke\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-02-28 17:04:23 Yeah8a8y}\\
{\it RE: Collusion  Tribes}\\
...
{\small 
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-01 15:28:10 Angus McIntyre}\\
{\it Performance, problems and fixes}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-01 16:29:54 Trash}\\
{\it RE: Performance, problems and fixes}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-01 16:09:48 Marvin}\\
{\it Reduced server list}\\	
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-02 22:21:25 Angus McIntyre}\\
{\it RE: Reduced server list}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-07 00:56:52 Martin}\\
{\it Nowhere to launch!!!}\\
All my agents are at home and I can launch them...nowhere!!!!!\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-07 13:30:22 Yeah8a8y}\\
{\it RE: Nowhere to launch!!!}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-07 22:10:09 Yeah8a8y}\\
{\it RE: Nowhere to launch!!!}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-08 13:39:58 Yeah8a8y}\\
{\it	Bahhh!!!}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-08 15:50:55 phlox}\\
{\it RE: Hull5 Sony 0}\\
glad to see someones stopping sony's ethnic cleansing of our bots. excellent.\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-08 15:51:52 Yeah8a8y}\\
{\it In t' kingdon of t' blind, t' 1-eyed man is king}\\
...
{\it RE: In t' kingdon of t' blind, t' 1-eyed man is ki}\\
...
{\it RE: who is on whos side??}\\
{\it i am most definitely NOT one of them!}\\
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-09 14:26:15 fish}\\
{\it We are continuing to test software fixes...}\\
...
\rule{0.8\textwidth}{.4pt}\\
{\bf 2000-03-09 16:13:23 phlox}\\
{\it we're still waiting. . .}\\
...
to the design of a sophisticated framework for housing the computer equipment (see figure \ref{fig:palais}), 
...
\caption{\small\label{fig:palais} 
...
show the experiment live in other locations. So we made a portable version (see Figure \ref{fig:road}) that could easily 
...
1. The {\it European Conference on Artificial Life} at the EPFL in Lausanne (Switzerland) in september 1999. 
...
\caption{\small\label{fig:lausanne} 
Live installation and demonstration of the Talking Heads experiment at the European Conference on Artificial 
Life in 1999.}
\end{figure}

2. The {\it Neuer Aachener Kunstverein} in Aachen (Germany) in collaboration with the 
...
3. The portable Talking Heads was also featured in an exhibition at the {\it Ludo Mich Gallery} in Antwerp. This 
...
The {\it Mus\'ee d'Art Moderne} in Paris organised a solo exhibition of artist Olafur Eliasson entitled 
...
which in itself gave a very strong visual effect (see figure \ref{fig:lookintobox}). 
...
\caption{\small\label{fig:lookintobox} 
...
Look into the Box was realised and operated (see Figure \ref{fig:spoleto}). A system for playing language games 
...
\caption{\small\label{fig:spoleto} 
...
to 12 february 2007 (see Figure \ref{fig:intensive-science}). 
\begin{figure}[htbp]
  \centerline{\includegraphics[width=.80\textwidth]{chap9/figs/explorascience}}
\caption{\small\label{fig:intensive-science} 
