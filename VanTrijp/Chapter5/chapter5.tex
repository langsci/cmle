...
\subsubsection{Derivational versus non-deriv\is{derivation}ational constructions.}
...
\subsubsection{The emergence\is{emergence} of \is{event structure}\is{construction!argument structure construction}argument structure constructions.}
...
\subsubsection{Innovation through analog\is{analogy}y and pattern formation\is{pattern formation}\is{formation}.}
...
\subsubsection{Multi-level selection\is{selection}\is{multi-level selection} in the emergence\is{emergence} of language systematicity\is{systematicity}.}
...
\subsubsection{On the status of inheritance\is{inheritance} networks.}
...
\subsubsection{The universality of semantic map\is{semantic maps}s.}
...
\subsubsection{Prior work on concept\is{concept formation} emergence.}
...
\subsubsection{Analog\is{analogy}y, pattern formation\is{pattern formation}\is{formation} and multi-level selection\is{selection}\is{multi-level selection}.}
...
\subsubsection{Example: the English\is{English} verbal gerund\is{verbal gerund}.} 
